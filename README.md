...
Download binaries with the latest build of LAStools [https://rapidlasso.de/downloads/].
To build from scratch please see the README_build.md file.


## Licensing

This tool is free to use. The source is available at github (https://github.com/LAStools/e572las) and licensed as LGPL v3.0 (http://www.gnu.org/licenses/lgpl-3.0.de.html).
